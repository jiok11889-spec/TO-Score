...
# 2026-08-04 재배분: 탈퇴 5명(김지수·김수민·손원우·황호연·김서래) 랭킹 제외 → N=32
# 탈퇴자는 config.RETIRED_PLAYERS로 관리하며 시트 행·과거 스코어는 보존한다.
...
TIER_MAP = {
    ...
    "황인호": 2, "임익준": 2, "이준범": 2,
    # 티어 3 (7명): 조성태·강충현 96.00 경계 동점 → 규칙 C로 상위 흡수
    "윤현호": 3, "김성환(92)": 3, "조현민": 3, "류성준": 3,
    "권기표": 3, "조성태": 3, "강충현": 3,
    # 티어 4 (6명)
    "이호준": 4, "김현섭": 4, "박헌우": 4, "최원재": 4,
    "김준기": 4, "이건희": 4,
    # 티어 5 (5명)
    "이도영": 5, "백근호": 5, "옥지엽": 5, "서정권": 5,
    "주홍석": 5,
}
